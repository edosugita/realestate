...
export const IconStarTwo = ({
    ...
    return (
        ...
        >
            ...
            <path
                d="M8.02 21.3501L11.01 19.5801C11.284 19.4207 11.6425 19.3407 12 19.3401V2.07764C11.3708 2.077 10.7403 2.5545 10.26 3.51014L8.5 7.03014C8.26 7.52014 7.62 7.99014 7.09 8.08014L3.9 8.61014C1.86 8.95014 1.39 10.4301 2.85 11.8901L5.33 14.3701C5.75 14.7901 5.98 15.6001 5.85 16.1801L5.14 19.2501C4.58 21.6701 5.88 22.6201 8.02 21.3501Z"
                fill={fill}
            />
        </svg>
    )
